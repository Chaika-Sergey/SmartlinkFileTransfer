...
public:
	...
	STDMETHOD(GetRegister)(/*[in]*/ long offset, /*[out, retval]*/ long *regValue);
	STDMETHOD(WriteFileToDevice)();
	STDMETHOD(ReadFileFromDevice)();
	STDMETHOD(PrepareFileToTransfer)();
	STDMETHOD(SaveFileToDisk)();
